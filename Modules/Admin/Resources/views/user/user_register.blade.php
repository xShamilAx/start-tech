                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <ul class="right-stats">
                            ...
                            <div class="btn-group">
                                <a class="btn btn-primary" href="{{url('/admin/users')}}"> <i
                                        class="icon-arrow-bold-left"></i> Users list</a>
                            </div>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    {{ Form::select('role[]', App\Models\RoleModel::pluck('display_name', 'name'),isset($user_role) ? $user_role : '',array('class'=> 'form-control select2 validate[required]', 'multiple'=> "multiple" ,'id' => 'role')) }}
                                </div>
                            </div>
